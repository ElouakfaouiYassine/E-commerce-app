...
class AccessoriesCategoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view:View = inflater.inflate(R.layout.fragment_accessories_category, container, false)
        recyclerView = view.findViewById(R.id.rv_accessories_category)
    ...
    private fun loadAccessoriesProducts() {
        val accessoriesProductsCursor = databaseHelper.getProductsByCategory("Accessories")
        val accessoriesProductsList = mutableListOf<Products>()

        accessoriesProductsCursor?.use { cursor ->
            ...
            while (cursor.moveToNext()) {
                ...
                accessoriesProductsList.add(product)
            }
        }

        adapter.updateData(accessoriesProductsList)
        accessoriesProductsCursor?.close()
    }
