...
class ManCategoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_man_category, container, false)
        recyclerView = view.findViewById(R.id.rv_man_category)
    ...
    private fun loadmanProducts() {
        val manProductsCursor = databaseHelper.getProductsByCategory("Man's")
        val manProductsList = mutableListOf<Products>()

        manProductsCursor?.use { cursor ->
        ...
        adapter.updateData(manProductsList)
        manProductsCursor?.close()
    }
