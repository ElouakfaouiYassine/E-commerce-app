...
data class Products(
    ...
    constructor(image_product: Uri?, nam_Product: String, description_Product: String, quantity_Product: Int, price_Product: Double, discount_Price_Product: Double) :
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeParcelable(image_product, flags)
